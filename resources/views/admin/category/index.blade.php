			...
			<div class="kt-portlet__head-toolbar">
				<div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions">
						...
						<button type="button" class="btn btn-brand btn-elevate btn-icon-sm" data-toggle="modal" data-target="#kt_modal_add_cate"><i class="la la-plus"></i>Thêm danh mục</button>
					</div>
				</div>
			</div>
		</div>
            ...
            <div class="modal-body">
                <form id="category_form" class="needs-validation">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" required id="category_description" name="category_description">
										</div>
