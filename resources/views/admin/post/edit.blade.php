            ...
            <div class="kt-portlet__body">
                <form id="post_form" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" required id="title" value="{{ $post->title  }}"
                               name="title">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <select class="form-control" name="category" id="category">
                            @foreach ($categories as $cate)
                                <option
                                    value="{{ $cate->id }}" {{ $cate->id === $post->category_id ? "selected" : "" }}>{{ $cate->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-check mb-2">
                        <input class="form-check-input" {{ $post->hot === 1 ? 'checked' : 'f' }} type="checkbox"
                               name="hot" id="hot">
