            ...
            <ul class="kt-menu__nav ">
                ...
                <li class="kt-menu__item  {{ request()->is('*profile*') ? 'kt-menu__item--active' : '' }}"
                    aria-haspopup="true"><a href="{{ route('profile.index') }}" class="kt-menu__link "><span
                            ...
                            </svg></span><span class="kt-menu__link-text">Thông tin tài khoản</span>
                    </a>
                </li>
                ...
                <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
                    data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
                        class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg
                            ...
                            </svg></span><span class="kt-menu__link-text">Quản lý phần quyền</span><i
                            class="kt-menu__ver-arrow la la-angle-right"></i></a>
                    <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                        <ul class="kt-menu__subnav">
                            <li class="kt-menu__item  kt-menu__item--parent" aria-haspopup="true"><span
                                    class="kt-menu__link"><span class="kt-menu__link-text">General</span></span></li>
                            <li class="kt-menu__item  {{ request()->is('*role*') ? 'kt-menu__item--active' : '' }}" aria-haspopup="true"><a
                                    href="{{route('role.index')}}" class="kt-menu__link "><i
                                        class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                                        class="kt-menu__link-text">Quản lý vai trò</span></a></li>
                        </ul>
                    </div>
                </li>
                @endcan
