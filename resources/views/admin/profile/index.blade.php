...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    ...
    <div class="kt-subheader__toolbar">
        <div class="btn-group">
            <button type="button" id="btnSave" class="btn btn-brand btn-bold">
                Cập nhật</button>
        </div>
    </div>
</div>
                                    ...
                                    <div class="kt-section__body">
                                        <div class="alert alert-solid-danger alert-bold fade show kt-margin-t-20 kt-margin-b-40"
                                            ...
                                            <div class="alert-text">Configure user passwords to expire periodically.
                                                <br>Users will need warning that their passwords are going to expire, or
                                                they might inadvertently get locked out of the system!</div>
